<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="flex items-center justify-between mt-6">
            <a class="underline text-sm text-pink-100 hover:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-300 transition duration-150" href="{{ route('login') }}">
