...
<body
    class="bg-[#120E2F] text-white flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col selection:bg-[#9B5975] selection:text-white">
    <header class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-6 not-has-[nav]:hidden">
        @if (Route::has('login'))
            <nav class="flex items-center justify-end gap-3">
                @auth
                    <a href="{{ url('/dashboard') }}"
                        class="inline-block px-5 py-2 bg-[#9B5975] hover:bg-[#A86481] text-white border border-white/20 rounded-xl text-sm font-medium shadow-md transition transform hover:scale-105">
                        Aurora Dashboard
                    </a>
                @else
                    <a href="{{ route('login') }}"
                        class="inline-block px-5 py-2 text-pink-100 hover:text-white hover:bg-white/10 rounded-xl text-sm font-medium transition">
                        Log in
                    </a>
    ...
    <div class="content w-full flex justify-center">
        <div
            ...
            <div class="flex items-center justify-center mb-6 lg:mb-10 w-full">
                <img src="{{ asset('images/Aurora_Social_Media.jpg') }}" alt="Aurora"
                    class="w-[50vw] max-w-[50vw] h-auto object-contain rounded-2xl shadow-2xl border border-white/15"
                    style="width: 50vw; max-width: 50vw; height: auto;" />
            </div>
        </div>
    </div>
