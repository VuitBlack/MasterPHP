<nav x-data="{ open: false }" class="bg-[#120E2F] border-b border-[#9B5975]/30">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 rounded-md text-pink-200 hover:text-white hover:bg-[#9B5975]/30 focus:outline-none transition duration-150 ease-in-out">
    ...
    <div :class="{'block': open, 'hidden': ! open}"
        class="hidden sm:hidden bg-[#120E2F]/95 border-b border-[#9B5975]/30">
